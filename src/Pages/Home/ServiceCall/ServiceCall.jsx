const ServiceCall = () => {
      return (
            <>
                  <section className="w-full m-12 mx-auto" data-aos="zoom-in-left">
                        <div
                              className={`relative z-10 overflow-hidden rounded bg-teal-200 py-12 px-8 md:p-[70px]`}
                        >
                              <div className="flex flex-wrap items-center -mx-4">
                                    <div className="w-full px-4 lg:w-1/2">
                                          <span className="mb-2 text-base font-semibold text-black">
                                                Find service to take next
                                          </span>
                                          <h2 className="mb-6 text-3xl w-[60%] font-bold leading-tight text-black sm:mb-8 sm:text-[38px] lg:mb-0">
                                                Get Services with our free trial
                                          </h2>
                                    </div>
                                    <div className="w-full px-4 lg:w-1/2">
